            ...
            <section id="recetas">
                <div class="flex flex-col items-center justify-center gap-3 rounded-lg w-full my-8">
                    <?php
                        ...
                        $recipe = RecipeController::getRecipeById();
                        if ($recipe) {
                            echo '
                            <div class="receta flex flex-col items-center justify-center gap-3 p-6 bg-violet-100 rounded-lg w-5/6 max-w-5xl shadow-lg my-3">
                                <h2 class="text-4xl font-bold text-violet-400 text-center">' . $recipe->name . '</h1>
                                ...
                                <p class="text-lg text-center"><span class="font-bold">Categorías:</span> ' . $recipe->getParsedCategories() . '</p">
                                <hr></hr>
                                <p class="text-lg w-full">' . $recipe->instructions . '</p">
                                <hr></hr>
                                <img class="h-96 mt-3 rounded-lg" src="' . $recipe->image_url . '" alt="' . $recipe->name . '">
                            </div>
                            ';
                        } else {
                            echo '<h2 class="text-4xl font-bold text-violet-400 text-center py-10">Receta no encontrada</h1>';
                        }
                    ?>
                </div>
            </section>
